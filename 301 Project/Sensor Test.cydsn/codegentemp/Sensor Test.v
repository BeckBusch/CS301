...
module ADC_SAR_v3_10_0 (
	...
	cy_clock_v1_0
		#(.id("4a73d0e7-e462-44b0-9e5e-6e4da307dbbb/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4a73d0e7-e462-44b0-9e5e-6e4da307dbbb/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
// ADC_SAR_v3_10(ADC_Clock=1, ADC_Clock_Frequency=1800000, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=1, ADC_Resolution=12, ADC_SampleMode=1, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=6, Sample_Rate=100000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_10, CY_CONFIG_TITLE=ADC_SAR_2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_2, CY_INSTANCE_SHORT_NAME=ADC_SAR_2, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=ADC_SAR_2, )
module ADC_SAR_v3_10_1 (
	...
	cy_clock_v1_0
		#(.id("f8cecd40-39d8-41ef-b797-debb0ee151e8/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("555555555.555556"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f8cecd40-39d8-41ef-b797-debb0ee151e8/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__singal_in_1_net;
	wire [0:0] tmpFB_0__singal_in_1_net;
	wire [0:0] tmpIO_0__singal_in_1_net;
	wire [0:0] tmpINTERRUPT_0__singal_in_1_net;
	electrical [0:0] tmpSIOVREF__singal_in_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		singal_in_1
		 (.oe(tmpOE__singal_in_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__singal_in_1_net[0:0]}),
		  .analog({Net_6}),
		  .io({tmpIO_0__singal_in_1_net[0:0]}),
		  .siovref(tmpSIOVREF__singal_in_1_net),
		  .interrupt({tmpINTERRUPT_0__singal_in_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__singal_in_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__singal_in_2_net;
	wire [0:0] tmpFB_0__singal_in_2_net;
	wire [0:0] tmpIO_0__singal_in_2_net;
	wire [0:0] tmpINTERRUPT_0__singal_in_2_net;
	electrical [0:0] tmpSIOVREF__singal_in_2_net;

	cy_psoc3_pins_v1_10
		#(.id("f2e86151-f646-40e6-a633-d5cc510bc9b7"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		singal_in_2
		 (.oe(tmpOE__singal_in_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__singal_in_2_net[0:0]}),
		  .analog({Net_13}),
		  .io({tmpIO_0__singal_in_2_net[0:0]}),
		  .siovref(tmpSIOVREF__singal_in_2_net),
		  .interrupt({tmpINTERRUPT_0__singal_in_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__singal_in_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("a76eef87-3f3a-4245-b69e-9b2f7960d2ef"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
